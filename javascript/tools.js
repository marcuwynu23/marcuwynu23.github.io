const toolProjects = [
	...
	{
		title: "Just Utility",
		description: "A commandline Utilities and Tools in window written c++ and uses window buildin utilities and other 3rd party tools automated, compacted and cascaded in a simple command. It is use for easy navigating in the terminal and for learning and developing simple projects, doing experiments,simple networking,etc.",
		link: "https://github.com/marcuwynu23/just-utility.git",
		language: "ExpressJS, Mongodb,NodeJS and Nunjucks Template Engine",
		topics: ["console", "cmd", "commandline-tool", "c++", "makefile", "terminal development", "windows", "shell"],
		screenshots: [
	...
	},
	{
		...
		language: "html, css, javascript,python",
		topics: ["html", "console", "tool", "requests", "data", "datasets", "scraping", "python", "python scraping"],
		screenshots: [
