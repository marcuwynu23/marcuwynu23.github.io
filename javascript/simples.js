const simpleProjects = [
  ...
  },
  {
    ...
    language: 'Python',
    topics: ['job-application', 'job-application-emailer', 'Automate', 'Automation', 'scripting'],
    screenshots: ['assets/screenshots/simples/job-application-emailer/image.jpg'],
  },
  {
    ...
    language: 'Javascript',
    topics: ['cli', 'qrcode', 'certificate', 'document', 'scripting', 'automate', 'automation'],
    screenshots: ['assets/screenshots/simples/document-maker-automation/image.jpg'],
  },
  {
    title: 'AI Assistant Chat App',
    description: 'A simple chat app that uses ai assistant to reply to messages',
