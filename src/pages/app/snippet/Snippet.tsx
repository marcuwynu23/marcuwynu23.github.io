  ...
  return (
    <>
      <div className=" mx-auto px-4 py-6">
        <h1 className="text-2xl font-semibold text-foreground mb-4 tracking-tight">Snippets</h1>
              ...
              filteredSnippets.map((snippet, index) => (
                ...
                >
                  <CardHeader className="p-0">
                    <CardTitle className="text-lg font-semibold text-foreground">{snippet.title}</CardTitle>
                  </CardHeader>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        ...
        >
          <DialogHeader>
            <DialogTitle className="text-xl font-semibold text-foreground">{selectedSnippet?.title}</DialogTitle>
            <DialogDescription className="text-muted-foreground">{selectedSnippet?.description}</DialogDescription>
          </DialogHeader>
          <div className="mt-4">
